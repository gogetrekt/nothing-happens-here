import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, createElementBlock, ref, h, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, mergeProps, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { c as createError$1, o as parseURL, q as encodePath, s as decodePath, v as hasProtocol, x as isScriptProtocol, n as joinURL, w as withQuery, y as sanitizeStatusCode, z as getContext, $ as $fetch, A as baseURL, B as createHooks, C as executeAsync, D as defu } from '../_/nitro.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__nuxt_content/poems/sql_dump.txt") {
      r.unshift({ data: $0 });
    }
    let s = p.split("/");
    s.length - 1;
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CBqEROM1.mjs')
  },
  {
    name: "write",
    path: "/write",
    component: () => import('./write-BmhD0TIH.mjs')
  },
  {
    name: "editor",
    path: "/editor",
    component: () => import('./editor-DMYzitgR.mjs'),
    children: [
      {
        name: "editor-id",
        path: ":id()",
        component: () => import('./_id_-bg8CjVuV.mjs')
      }
    ]
  },
  {
    name: "archive",
    path: "/archive",
    component: () => import('./archive-D2c73j1b.mjs')
  },
  {
    name: "poem-slug",
    path: "/poem/:slug()",
    component: () => import('./_slug_-CoiiCLmI.mjs')
  },
  {
    name: "sanctum-new",
    path: "/sanctum/new",
    meta: { "middleware": "sanctum-auth" },
    component: () => import('./new-CFUTU6Yj.mjs')
  },
  {
    name: "sanctum-login",
    path: "/sanctum-login",
    meta: __nuxt_page_meta || {},
    component: () => import('./sanctum-login-D-EY3GEX.mjs')
  },
  {
    name: "sanctum",
    path: "/sanctum",
    meta: { "middleware": "sanctum-auth" },
    component: () => import('./index-CZXl8RI5.mjs')
  },
  {
    name: "sanctum-edit-id",
    path: "/sanctum/edit/:id()",
    meta: { "middleware": "sanctum-auth" },
    component: () => import('./_id_-BaGO_Z26.mjs')
  }
];
...
const namedMiddleware = {
  "sanctum-auth": () => import('./sanctum-auth-N8g_gODk.mjs')
};
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CIum0RqK.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BCqhmaeS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-LtjLKhdT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-C1XgY2J1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DM4DA3tD.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DaK8QO4A.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-Djk9mF4t.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-2ot5LDvL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CU6Fx64O.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#0b0b0b]" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtRouteAnnouncer, null, null, _parent));
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`<footer class="w-full pt-16 pb-20"><p class="font-serif text-sm text-neutral-600 opacity-60 leading-relaxed text-center tracking-wide">left here by r</p></footer></div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-eBSmFW1v.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C5KAwj3m.mjs'));
...
export { useRoute as a, useRequestFetch as b, useNuxtApp as c, asyncDataDefaults as d, entry_default as default, createError as e, fetchDefaults as f, defineNuxtRouteMiddleware as g, encodeRoutePath as h, useRuntimeConfig as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, useRouter as u };
