...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b3129374-36a7-4c21-8c6f-c85ef423d96d",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/poems/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "supabaseUrl": "https://tjdylyldnbclbhczcugc.supabase.co",
  "supabaseKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRqZHlseWxkbmJjbGJoY3pjdWdjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI5MDMwNzAsImV4cCI6MjA4ODQ3OTA3MH0.sJ8lEKYtdobAVEIVkxcqiKsA0abB-x0C7WoTxcG4SDY",
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/USER/Desktop/nothinghappenshere/nothing-happens-here/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _W2J2sv = eventHandler(async (event) => {
...
const checksums = {
  "poems": "v3.5.0--uT8ZL6Br4YLR580iRtyKyoyn3XLnUTihJ6sYF3-bROA"
};
const checksumsStructure = {
  "poems": "yPFplbmYKO9-Fm73FDSm_4NHJuDJZ1j6zkKG6OTs0Q8"
};

const tables = {
  "poems": "_content_poems",
  "info": "_content_info"
};
...
const _ECBZOj = eventHandler(async (event) => {
...
const _lazy_CvdDs6 = () => import('../routes/api/poems.get.mjs');
const _lazy_H9CEUm = () => import('../routes/api/poems.post.mjs');
const _lazy_s5fuin = () => import('../routes/api/poems/_id_.delete.mjs');
const _lazy_8tPXBv = () => import('../routes/api/poems/_id_.get.mjs');
const _lazy_tR3t8H = () => import('../routes/api/poems/_id_.put.mjs');
const _lazy_66ESlu = () => import('../routes/api/poems/slug/_slug_.get.mjs');
const _lazy_WHZqRl = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/poems', handler: _lazy_CvdDs6, lazy: true, middleware: false, method: "get" },
  { route: '/api/poems', handler: _lazy_H9CEUm, lazy: true, middleware: false, method: "post" },
  { route: '/api/poems/:id', handler: _lazy_s5fuin, lazy: true, middleware: false, method: "delete" },
  { route: '/api/poems/:id', handler: _lazy_8tPXBv, lazy: true, middleware: false, method: "get" },
  { route: '/api/poems/:id', handler: _lazy_tR3t8H, lazy: true, middleware: false, method: "put" },
  { route: '/api/poems/slug/:slug', handler: _lazy_66ESlu, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_WHZqRl, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/poems/sql_dump.txt', handler: _W2J2sv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _W2J2sv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/poems/query', handler: _ECBZOj, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _ECBZOj, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WHZqRl, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, baseURL as A, createHooks as B, executeAsync as C, defu as D, hash$1 as E, withTrailingSlash as F, withoutTrailingSlash as G, withLeadingSlash as H, useRuntimeConfig as a, getRouterParam as b, createError$1 as c, defineEventHandler as d, buildAssetsURL as e, getResponseStatusText as f, getRouteRulesForPath as g, getResponseStatus as h, defineRenderHandler as i, publicAssetsURL as j, getQuery as k, destr as l, getRouteRules as m, joinURL as n, parseURL as o, parseQuery as p, encodePath as q, readBody as r, decodePath as s, toNodeListener as t, useNitroApp as u, hasProtocol as v, withQuery as w, isScriptProtocol as x, sanitizeStatusCode as y, getContext as z };
